...
<a href="./pages/page-img.html">click on image<li><img src="../../assets/images/copy.jpg" alt="flower-img" style={{width:"100%", height:"300px" , border:"3px dotted crimson"}}/></li></a>
</ul>
    </>
  )
}
